...
#set_property PACKAGE_PIN W15 [get_ports {UP}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {UP}]
#set_property PACKAGE_PIN V15 [get_ports {LT}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {LT}]
#set_property PACKAGE_PIN W14 [get_ports {RT}]
...
# LEDs
#set_property PACKAGE_PIN U16 [get_ports {Move_Dn}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Move_Dn}]
#set_property PACKAGE_PIN E19 [get_ports {Move_Up}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Move_Up}]
#set_property PACKAGE_PIN U19 [get_ports {Move_Lt}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Move_Lt}]
#set_property PACKAGE_PIN V19 [get_ports {Move_Rt}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Move_Rt}]
...
#Buttons
#set_property PACKAGE_PIN U18 [get_ports CT]
	#set_property IOSTANDARD LVCMOS33 [get_ports CT]
	#set_property CLOCK_DEDICATED_ROUTE FALSE[get_nets top/CT_IBUF] 
set_property PACKAGE_PIN T18 [get_ports UP]
	set_property IOSTANDARD LVCMOS33 [get_ports UP]
set_property PACKAGE_PIN W19 [get_ports LT]
	set_property IOSTANDARD LVCMOS33 [get_ports LT]
set_property PACKAGE_PIN T17 [get_ports RT]
	set_property IOSTANDARD LVCMOS33 [get_ports RT]
